...
def run_imu_odom_scan_mapping(bag_dir_path, speed=1.0):
    ...
    print("Initializing Probabilistic Occupancy Grid Mapping with ICP...")
        ...
        for connection, _, rawdata in reader.messages(connections=connections):
            ...
            if connection.topic == IMU_TOPIC:
                ...
                if imu_bias_z is None:
                    ...
                    if len(bias_samples) >= CALIBRATION_FRAMES:
                        ...
                        print(f"IMU calibration complete. Z-axis bias: {imu_bias_z:.6f} rad/s")
                    continue
            ...
            #  3. LiDAR Scan Processing & ICP 
                ...
                if start_anchor_points is None and 0.2 < total_dist_traveled < 1.0:
                    ...
                    print(f"Anchor saved at yaw: {math.degrees(yaw):.1f} deg. This is now ground truth.")
                ...
                if (msg_time_sec - last_icp_time) >= ICP_INTERVAL:
                    ...
                    if ref_points is not None:
                        ...
                        if do_heading_reset:
                            ...
                            print(f"Loop closed. Lateral shift: {lateral_shift:.2f}m, rotation: {delta_yaw:.2f}rad")
                        ...
                        # else:
                        #     print(f"ICP rejected: requested jump {delta_dist:.2f}m backwards/forwards.")
    ...
    print("Map saved to: slam_map_final.png")
